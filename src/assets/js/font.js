!function(x) {
    function w() {
        ...
        a / v > 750 && (a = 750 * v), x.rem = a / 18.75, r.style.fontSize = x.rem + "px"
    }
    ...
    }, !1)/*设置body为12px       , "complete" === s.readyState ? s.body.style.fontSize = 12 * v + "px" : s.addEventListener("DOMContentLoaded", function() {
